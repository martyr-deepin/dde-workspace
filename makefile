...
jsc_extension: jsc_extension/*.cfg lib/jsc_gen.py
	...
	cd jsc_extension && gcc -c -I../lib *.c `pkg-config --libs --cflags webkitgtk-3.0`


desktop: desktop.c jsc_extension/*.o lib/webview.c lib/desktop_entry.c lib/LauncherInspectorWindow.c lib/utils.c lib/forward_window.c 
	gcc -o desktop $^ -I./lib -L~/.lib `pkg-config --libs --cflags gtk+-3.0 webkitgtk-3.0` -std=c99 -lX11 -g 
