...
JS_EXPORT_API
gboolean shutdown_get_can_hibernate ()
{
    return lightdm_get_can_hibernate ();
}

JS_EXPORT_API
gboolean shutdown_get_can_restart ()
{
    return lightdm_get_can_restart ();
}

JS_EXPORT_API
gboolean shutdown_get_can_shutdown ()
{
    return lightdm_get_can_shutdown ();
}

JS_EXPORT_API
gboolean shutdown_run_suspend ()
{
    return lightdm_suspend (NULL);
}

JS_EXPORT_API
gboolean shutdown_run_hibernate ()
{
    return lightdm_hibernate (NULL);
}

JS_EXPORT_API
gboolean shutdown_run_restart ()
{
    return lightdm_restart (NULL);
}

JS_EXPORT_API
gboolean shutdown_run_shutdown ()
{
