...
(function() {
  var AudioHelper, DEEPIN_ITEM_ID, Module, Plugin, PluginManager, Widget, ajax, assert, build_menu, calc_text_size, clamp, create_element, create_img, dnd_is_deepin_item, dnd_is_desktop, dnd_is_file, echo, find_drag_target, get_function_name, get_page_xy, get_path_base, get_path_name, run_post, swap_element, _, _events,
  ...
  AudioHelper = (function(_super) {
    ...
    function AudioHelper(id) {
      ...
      this.img = create_img(null, "" + _plugin.path + "/main.png", this.element);
    }
