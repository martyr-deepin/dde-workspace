...
var DesktopEntry, Folder, IconGroup, Item, Widget, db_conn, item, render_item, _i, _len, _ref,
...
db_conn.transaction(function(tx) {
  return tx.executeSql("CREATE TABLE WidgetInfo (id REAL UNIQUE, x Int, y Int)", [], function(result) {}, function(tx, error) {
...
Widget = (function() {
  ...
  Widget.prototype.save_info = function() {
    ...
    return db_conn.transaction(function(tx) {
      return tx.executeSql("insert into WidgetInfo (id, x, y) values(?, ?, ?)", [_this.id, _this.get_x(), _this.get_y()], function(result) {}, function(tx, error) {
        return console.log(error);
      });
    });
  };
...
Item = (function(_super) {
  ...
  Item.prototype.render = function() {
    ...
    that = this;
    return this._$().draggable().dblclick(function() {
      DCore.run_command($(this)[0].getAttribute('exec'));
      return that.save_info();
    });
  };

  Item.prototype.load_info = function() {};
